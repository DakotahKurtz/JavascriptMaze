...
public class ASCIIMazeGenerator
{
    ...
    public ASCIIMazeGenerator(int height, int width) {
        this.height = height;
        this.width = width;
    ...
    private void make(int minY, int maxY, int minX, int maxX)
    {
        ...
        if ((width > 3 || height > 3) && (width > 2 && height > 2))
        {
            ...
            {
                splitHorizontal(minY, maxY, minX, maxX);
            } else
            {
                splitVertical(minY, maxY, minX, maxX);
            }
        }
    }
    ...
    private void splitHorizontal(int minY, int maxY, int minX, int maxX) {
        ...
        //bottom partition
        make(minY, wallY, minX, maxX);

        // top partition
        make(wallY, maxY, minX, maxX);
    }
    ...
    private void splitVertical(int minY, int maxY, int minX, int maxX) {
        ...
        // left partition
        make(minY, maxY, minX, wallX);

        // top partition
        make(minY, maxY, wallX, maxX);
    }
